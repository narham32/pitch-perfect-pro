...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PitchForge — Football Competition Platform" },
      {
        name: "description",
        content:
          "Run football competitions end to end: fixtures, live match events, standings and top scorers.",
      },
      { property: "og:title", content: "PitchForge — Football Competition Platform" },
      {
